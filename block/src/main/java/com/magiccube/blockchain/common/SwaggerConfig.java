...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = {"com.magiccube"})
public class SwaggerConfig extends WebMvcConfigurerAdapter {
	...
	public Docket customDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.magiccube.blockchain.core.controller"))
	...
	private ApiInfo apiInfo() {
		Contact contact = new Contact("magiccube", "", "sh081042@gmail.com");
